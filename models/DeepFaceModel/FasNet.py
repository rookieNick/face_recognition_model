...
class Fasnet:
    ...
    def __init__(self):
        ...
        state_dict = torch.load(first_model_weight_file, map_location=device, weights_only=True)
        ...
        state_dict = torch.load(second_model_weight_file, map_location=device, weights_only=True)
        keys = iter(state_dict)
        first_layer_name = keys.__next__()
